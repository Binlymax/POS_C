              ...
              <div class="row">
                 ...
                 <div class="col-md-8">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="mem_password" class="form-control" id="mem_password" placeholder="Input password" required="" value="" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="mem_address" class="form-control" id="mem_address" placeholder="" value="<?php echo $row['mem_address'];?>">
                    </div>
                  </div>
