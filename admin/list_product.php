    ...
    <div class="card card-gray">
      <div class="card-header ">
        ...
        <div align="right">
          ...
          <button type="button" class="btn btn-light" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus"></i> Add product</button>
            ...
            <table id="example1" class="table table-bordered  table-hover table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href="product_db.php?p_id=<?php echo $row_product['p_id']; ?>" class="del-btn btn btn-danger"><i class="fas fas fa-trash"></i> Delete</a></td>
