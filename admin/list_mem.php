    ...
    <div class="card card-gray">
      <div class="card-header ">
        ...
        <div align="right">
          ...
          <button type="button" class="btn btn-light" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus"></i> Add member</button>
            ...
            <table id="example1" class="table table-bordered  table-hover table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href="member_db.php?mem_id=<?php echo $row_member['mem_id'];?>&&member=del" class="del-btn btn btn-danger" onclick = "return confirm('Do you want to delete data?')"><i class="fas fas fa-trash"></i> Del</a></td>
      ...
      <form action="member_db.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-content">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" name="mem_password" class="form-control" id="mem_password" placeholder="Input password" value="" required>
            </div>
          </div>
          <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">Address </label>
            <div class="col-sm-10">
              <input type="text" name="mem_address" class="form-control" id="mem_address" placeholder="" value="" required>
            </div>
          </div>
          <div class="form-group row">
