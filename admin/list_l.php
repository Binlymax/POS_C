 ...
 <!-- Content Header (Page header) -->
    ...
    <div class="card card-gray">
            <div class="card-header ">
              <h3 class="card-title">PRODUCT IN STOCK</h3>
            </div>
            <br>
              ...
              <div class="card-body">
                ...
                <div class="col-md-12">
                 ...
                 <div class="input-group">
                    <input type="text" name="p_id" class="form-control" placeholder="Search item ID" autofocus >
                    <!-- <input onkeyup="searchsomething(this)" id="p_name" type="text" class="sidebar-search" placeholder="Search something..."> -->
                          ...
                          <?php if ($row >0) {?> 
                            ...
                            <div class="card" style="">
                              ...
                              <div class="card-body">
                                ...
                                <p class="card-text"><?php echo number_format($rs_prd['p_price']); ?> Đông</p>
                                ...
                                <?php if($rs_prd['p_qty'] > 0){ ?>
                                  <center>  
                                          ...
                                          <a href="list_l.php?p_id=<?php echo $rs_prd['p_id'];?>&act=add" class="btn btn-success" target=""><i class="fa fa-shopping-cart"></i> Add Order</a>
                                          </center>
                                <?php } else { ?>
