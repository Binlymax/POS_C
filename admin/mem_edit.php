              ...
              <div class="row">
                 ...
                 <div class="col-md-8">
                   <form action="member_db.php" method="POST" enctype="multipart/form-data">
                    ...
                    <label for="" class="col-sm-2 col-form-label">Usage level </label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="mem_password" class="form-control" id="mem_password" placeholder="Enter your password" required="" value="" required>
                    </div>
                  </div>

                  <div class="form-group row">
                    <label for="mem_address" class="col-sm-2 col-form-label">Address</label>
                    <div class="col-sm-10">
                    <input type="text" name="mem_address" class="form-control" id="mem_address" placeholder="Enter your address" value="<?php echo $row['mem_address']; ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input type="text" name="mem_phone" class="form-control" id="mem_phone" placeholder="" value="<?php echo $row['mem_phone']; ?>">
                    </div>
                  </div>
