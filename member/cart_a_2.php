...
if(!empty($_SESSION['cart']))
{
	...
	foreach($_SESSION['cart'] as $p_id=>$qty)
	{
		...
		//remove product
        echo "<td align='center'><a href='list_l.php?p_id=$p_id&act=remove' class='btn btn-danger btn-xs'>X</a></td>";
        echo "</tr>";
	...
	echo "<td></td>";
  	...
  	echo "<td bgcolor='#CEE7FF' align='center'><b>Total price</b></td>";
...
<!-- <a href="#" target="" class="btn btn-success" onclick="window.print()">Print</a> -->
		...
		<input type="submit" name="button" id="button" value="Amend" class="btn btn-warning" />

        <input type="button" name="Submit2" value="Make a list" onclick="window.location='confirm_a.php';" class="btn btn-primary" />
