...
<head>
  ...
  <title>POS System | Phisidxay</title>
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <center><img width="200 px" src="GGWP.png"><br>
    <h3><b>POS System  </b></h3> <h5>Please Login</h5></center><br>
     <!--  <p class="login-box-msg">เข้าสู่ระบบ</p> -->
      <form action="chk_login.php" method="post">
        ...
        <div class="social-auth-links text-center mb-3">
          ...
          <a href="user_list.php" class="btn btn-primary btn-block">Register</a>
          <!-- <a href="register.php" class="btn btn-block btn-secondary">Register</a> -->
